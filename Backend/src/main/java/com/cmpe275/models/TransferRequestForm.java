...
public class TransferRequestForm {
	private long id;
	...
	private List<TransferRequestShallowForm> otherTransactions;
	...
	public List<TransferRequestShallowForm> getOtherTransactions() {
		return otherTransactions;
	}

	public void setOtherTransactions(List<TransferRequestShallowForm> otherTransactions) {
